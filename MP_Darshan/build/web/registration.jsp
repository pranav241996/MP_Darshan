    ...
    <body >
     ...
     <div align="center" class="select1" >
          <div class="ui container" >
              <br/><br/><br/><br/><br/>
                            <h1  style="font-size: 48px" ><b>MP DARSHAN</b></h1>
...
<!--                
        ...
        <div id="d3" style="display: none">
            <br/><br/>
            <p style="font-size: 40px; color: white"> Hey! <u><b id="p2" style="color: red"> </b> </u>Please Give your Contact No.? <font style="color: red">*</font></p>
        ...
        <div id="d5" style="display: none" >
            <br/><br/>
            <p style="font-size: 40px; color: white"><u> <b id="p4" style="color: red"> </b></u> Your Country?</p>
...
<!--        <div id="d6" style="display: none" >
        ...
        <div id="notshow1" style="display: none">
             ...
             Contact<input type="text" name="Contact" id="t3">
             E-mail<input type="email" name="Email" id="t4">
             Country<input type="text" name="Country" id="t5">
<!--             Semester<input type="text" name="sem" id="t6">
             section<input type="text" name="sec" id="t7">-->
               password <input type="password" name="Password" id="t8">
...
//                    document.getElementById("notshow1").style.display="block";

          ...
          // message.setText(msg); 
           message.setContent(
              "<div align='center'><h1 style='background-color:yellow; color:red'><br/><br/>OTP -> <i>"+msg+"</i><br/><br/>" +
                      "  PLEASE ENTER THE OTP IN VERIFICATION LINK->  http://localhost:8084/MP_DARSHAN/linklogin.jsp </h1> </div>",
             "text/html");
...
//     String b=forotp.otpval;
     ...
     Mailer.send("mpdarshan9@gmail.com","9407101191",tomail,"Thanks for Registration" , botp );  
